        ...
        for file_or_dir in os.listdir(folder_path):
            ...
            if os.path.isdir(file_or_dir_path):
                for file in os.listdir(file_or_dir_path):
                    ...
                    print("Loading image:", image_path)  # Debugging line
...
test_image_path = 'D:/soil classification/test/Sand/4.jpg'
...
if predicted_class == "Gravel":
    print("Gravelly soil tends to be well-draining but may not retain water and nutrients as effectively. Crops that can tolerate well-draining conditions and do not require high fertility may be suitable. Recommended crops: Grapevines, certain varieties of strawberries, drought-tolerant vegetables (e.g., tomatoes, peppers), and herbs like rosemary.")
    
if predicted_class == "Sand":
    print("Sandy soil drains quickly but may lack fertility and moisture retention. Crops that thrive in well-draining conditions and can tolerate lower fertility are suitable for sandy soil. Recommended crops: Carrots, radishes, potatoes, asparagus, melons, and drought-tolerant plants like lavender.")
if predicted_class == "Silt":
    print("Silt has finer particles and better moisture retention than sand. It is fertile and suitable for a wide range of crops. Recommended crops: Beans, peas, leafy greens (e.g., lettuce, spinach), broccoli, cabbage, and most garden vegetables. Silt soil is versatile and supports various crops.")