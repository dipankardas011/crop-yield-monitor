...
func New(
	...
	return &Server{
		...
		Predict:             NewPredictHandler(e.Predict, mux, decoder, encoder, errhandler, formatter),
...
func Mount(mux goahttp.Muxer, h *Server) {
	MountPredictHandler(mux, h.Predict)
...
// MountPredictHandler configures the mux to serve the "servers" service
// "predict" endpoint.
func MountPredictHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/predict", f)
}

// NewPredictHandler creates a HTTP handler which loads the HTTP request and
// calls the "servers" service "predict" endpoint.
func NewPredictHandler(
	...
	var (
		decodeRequest  = DecodePredictRequest(mux, decoder)
		encodeResponse = EncodePredictResponse(encoder)
		encodeError    = goahttp.ErrorEncoder(encoder, formatter)
	)
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		ctx := context.WithValue(r.Context(), goahttp.AcceptTypeKey, r.Header.Get("Accept"))
		ctx = context.WithValue(ctx, goa.MethodKey, "predict")
